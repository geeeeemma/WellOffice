  ...
  return (
    <div className="min-h-screen">
      <div className="container mx-auto p-6 space-y-8">
        {/* Colorful Header */}
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-blue-700 via-purple-700 to-indigo-800 p-6 text-white shadow-xl">
          <div className="absolute inset-0 bg-black/5" />
          <div className="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full -translate-y-16 translate-x-16" />
          
          <div className="relative z-10 flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white mb-1">WellOffice Dashboard</h1>
              <p className="text-white/90">Monitoraggio comfort ambientale in tempo reale</p>
            </div>
            <Button
        ...
        <div className="flex flex-row gap-6">
          {/* Ambienti Monitorati */}
          <div className="flex-1 bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900 dark:to-blue-800 rounded-xl p-6 shadow-lg border-0">
            ...
            <div className="text-3xl font-bold text-blue-800 dark:text-blue-100 mb-1">{environments.length}</div>
            <p className="text-xs text-blue-600 dark:text-blue-300">Spazi di lavoro attivi</p>
          </div>

          {/* Parametri Ottimali */}
          <div className="flex-1 bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900 dark:to-green-800 rounded-xl p-6 shadow-lg border-0">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-3xl font-bold text-green-800 dark:text-green-100 mb-1">{totalOptimal}</div>
            <p className="text-xs text-green-600 dark:text-green-300">Valori nella norma</p>
          </div>

          {/* Attenzioni */}
          <div className="flex-1 bg-gradient-to-br from-yellow-50 to-yellow-100 dark:from-yellow-900 dark:to-yellow-800 rounded-xl p-6 shadow-lg border-0">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-3xl font-bold text-yellow-800 dark:text-yellow-100 mb-1">{totalWarning}</div>
            <p className="text-xs text-yellow-600 dark:text-yellow-300">Richiedono monitoraggio</p>
          </div>

          {/* Critici */}
          <div className="flex-1 bg-gradient-to-br from-red-50 to-red-100 dark:from-red-900 dark:to-red-800 rounded-xl p-6 shadow-lg border-0">
            <div className="flex items-center justify-between mb-4">
            ...
            <div className="text-3xl font-bold text-red-800 dark:text-red-100 mb-1">{totalCritical}</div>
